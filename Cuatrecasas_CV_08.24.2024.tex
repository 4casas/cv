...
\item[–] R
\item[–] HTML/CSS
\item[–] My \LaTeX~code for this CV substantially modifies \href{https://www.latextemplates.com/template/compact-academic-cv}{this code} licensed (\href{https://creativecommons.org/licenses/by-nc-sa/3.0/}{CC BY-NC-SA 3.0}) by LaTeX Templates.}
\end{itemize}
\columnbreak
\item[] \textit{Natural}:
\begin{multicols}{2}
